...
just the categorical variable, transmission (`am`), i.e. $mpg \sim am$. See 
[Figure: Simple Linear Regression](#appendices). The coefficients of this simple
...
mile improves mileage by `r round(modelMLRsum$coef[3],3)` per second increase in
time.
