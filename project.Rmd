...
auto-mobile attributes surveyed, a linear regression model with transmission
type, weight and $^1/_4$ mile time, provide a better prediction for mileage than
using only the transmission type.
