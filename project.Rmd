...
This is further demonstrated by the plots of residual vs fitted values, see
[Figure: Fitted vs Residuals for Simple Linear Regresssion](#appendices). It
shows the values are clustered around the sample means. This is an indication of
poor model fit.
...
The [Figure: Fitted vs Residuals for Multi Linear Regresssion](#appendices) 
shows values that are more evenly spread, without any distinct cluster or
pattern. This further indicates a better model fit than the Simple linear
Regression Model.

Included in the Appendices is the plot [Figure: Multi Linear Regression: Normal 
...
This is however comes at a small cost of requiring additional regressors, namely
...
```{r risvsfitmodelSLR, fig.cap = "Fitted vs Residuals for Simple Linear Regresssion"}
...
```{r risvsfitmodelMLR, fig.cap = "Fitted vs Residuals for Multi Linear Regresssion"}
